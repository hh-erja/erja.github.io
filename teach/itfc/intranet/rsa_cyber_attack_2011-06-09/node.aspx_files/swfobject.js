...
var l=C.getVariablePairs().join("&");if(l.length>0){i+="flashvars=\""+l+"\""}
i+="/>"}else{if(C.getAttribute("doExpressInstall")){C.addVariable("MMplayerType","ActiveX")}
...
var c=C.getVariablePairs().join("&");if(c.length>0){i+="<param name=\"flashvars\" value=\""+c+"\" />"}
i+="</object>"}
...
if(I!=null){i=new deconcept.PlayerVersion(I.GetVariable("$version").split(" ")[1].split(","))}}
...
if(I.rev<i.rev){return false}
return true};deconcept.util={getRequestParameter:function(I){var o=document.location.search||document.location.hash;if(o){var i=o.substring(1).split("&");for(var l=0;l<i.length;l++){if(i[l].substring(0,i[l].indexOf("="))==I){return i[l].substring((i[l].indexOf("=")+1))}}}
return ""}};deconcept.SWFObjectUtil.cleanupSWFs=function(){var i=document.getElementsByTagName("OBJECT");for(var I=0;I<i.length;I++){i[I].style.display="none";for(var l in i[I]){if(typeof i[I][l]=="function"){i[I][l]=null}}}};if(typeof window.onunload=="function"){var oldunload=window.onunload;window.onunload=function(){deconcept.SWFObjectUtil.cleanupSWFs();oldunload()}}else{window.onunload=deconcept.SWFObjectUtil.cleanupSWFs}
